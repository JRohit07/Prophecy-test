...
class Reformat_5Test extends FunSuite with DataFrameSuiteBase {
  ...
  test("Unit Test 0") {
    ...
    val dfIn = createDfFromResourceFiles(
      spark,
      "/data/io/prophecy/pipelines/livy_scala/graph/Reformat_5/in/schema.json",
      "/data/io/prophecy/pipelines/livy_scala/graph/Reformat_5/in/data/unit_test_0.json",
      "in"
    )
    val dfOut = createDfFromResourceFiles(
      spark,
      "/data/io/prophecy/pipelines/livy_scala/graph/Reformat_5/out/schema.json",
      "/data/io/prophecy/pipelines/livy_scala/graph/Reformat_5/out/data/unit_test_0.json",
      "out"
    )

    val dfOutComputed =
      io.prophecy.pipelines.livy_scala.graph.Reformat_5(context, dfIn)
  ...
  test("Unit Test 1") {
    ...
    val dfIn = createDfFromResourceFiles(
      spark,
      "/data/io/prophecy/pipelines/livy_scala/graph/Reformat_5/in/schema.json",
      "/data/io/prophecy/pipelines/livy_scala/graph/Reformat_5/in/data/unit_test_1.json",
      "in"
    )
    val dfOut = createDfFromResourceFiles(
      spark,
      "/data/io/prophecy/pipelines/livy_scala/graph/Reformat_5/out/schema.json",
      "/data/io/prophecy/pipelines/livy_scala/graph/Reformat_5/out/data/unit_test_1.json",
      "out"
    )
