...
class Filter_2Test extends FunSuite with DataFrameSuiteBase {
  ...
  test("Unit Test 0") {
    ...
    val dfIn = createDfFromResourceFiles(
      ...
      "/data/io/prophecy/pipelines/livy_scala/graph/Filter_2/in/data/unit_test_0.json",
      "in"
    )
    val dfOut = createDfFromResourceFiles(
      spark,
      "/data/io/prophecy/pipelines/livy_scala/graph/Filter_2/out/schema.json",
      "/data/io/prophecy/pipelines/livy_scala/graph/Filter_2/out/data/unit_test_0.json",
      "out"
    )
