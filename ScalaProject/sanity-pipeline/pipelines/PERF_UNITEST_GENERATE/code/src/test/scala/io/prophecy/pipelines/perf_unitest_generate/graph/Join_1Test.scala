...
class Join_1Test extends FunSuite with DataFrameSuiteBase {
  ...
  test("Unit Test 0") {
    ...
    val dfIn0 = createDfFromResourceFiles(
      spark,
      "/data/io/prophecy/pipelines/perf_unitest_generate/graph/Join_1/in0/schema.json",
      "/data/io/prophecy/pipelines/perf_unitest_generate/graph/Join_1/in0/data/unit_test_0.json",
      "in0"
    )
    val dfIn1 = createDfFromResourceFiles(
      spark,
      "/data/io/prophecy/pipelines/perf_unitest_generate/graph/Join_1/in1/schema.json",
      "/data/io/prophecy/pipelines/perf_unitest_generate/graph/Join_1/in1/data/unit_test_0.json",
      "in1"
    )
    val dfOut = createDfFromResourceFiles(
      spark,
      "/data/io/prophecy/pipelines/perf_unitest_generate/graph/Join_1/out/schema.json",
      "/data/io/prophecy/pipelines/perf_unitest_generate/graph/Join_1/out/data/unit_test_0.json",
      "out"
    )

    val dfOutComputed = io.prophecy.pipelines.perf_unitest_generate.graph
      .Join_1(context, dfIn0, dfIn1)
