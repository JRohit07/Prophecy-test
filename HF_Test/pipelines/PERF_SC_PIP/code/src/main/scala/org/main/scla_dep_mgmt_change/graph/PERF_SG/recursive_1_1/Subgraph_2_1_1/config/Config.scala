package org.main.scla_dep_mgmt_change.graph.PERF_SG.recursive_1_1.Subgraph_2_1_1.config
...
case class Config(
  ...
  Subgraph_3_1_1:  Subgraph_3_1_1_Config = Subgraph_3_1_1_Config()
) extends ConfigBase
